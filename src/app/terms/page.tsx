        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-lg space-y-8">
          <section>
            ...
            <p className="text-slate-700 leading-relaxed">
              By accessing and using AcademIQ (&quot;the Service&quot;), you accept and agree to be bound by these Terms of Service.
          ...
          <section>
            ...
            <p className="text-slate-700 leading-relaxed mb-3">
              To use AcademIQ, you must create an account with accurate information. You are responsible for:
            </p>
          ...
          <section>
            ...
            <p className="text-slate-700 leading-relaxed">
              AcademIQ offers both free and paid subscription tiers. Paid subscriptions are billed monthly or annually
          ...
          <section>
            ...
            <p className="text-slate-700 leading-relaxed">
              All content on AcademIQ, including exam questions, course materials, software, designs, and trademarks,
              are owned by AcademIQ or its licensors. You are granted a limited, non-exclusive, non-transferable license
          ...
          <section>
            ...
            <p className="text-slate-700 leading-relaxed">
              AcademIQ uses artificial intelligence to generate exam questions based on uploaded course materials.
          ...
          <section>
            ...
            <p className="text-slate-700 leading-relaxed">
              AcademIQ is provided &quot;as is&quot; without warranties of any kind. We are not liable for any indirect, incidental,
          ...
          <section>
            ...
            <p className="text-slate-700 leading-relaxed">
              For questions about these Terms, please contact us at legal@academiq.com or through our Contact page.
            </p>
          </section>
        </div>
      </div>
